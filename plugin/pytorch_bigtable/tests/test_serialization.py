...
class BigtableSerializationTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    self.data = {"values": [i * 10 / 7 for i in range(10)],
      ...
      "float": [b"\x00\x00\x00\x00", b"?\xb6\xdbn", b"@6\xdbn", b"@\x89$\x92",
        b"@\xb6\xdbn", b"@\xe4\x92I", b"A\t$\x92", b"A \x00\x00", b"A6\xdbn",
        b"AM\xb6\xdb", ], "double": [b"\x00\x00\x00\x00\x00\x00\x00\x00",
        b"?\xf6\xdbm\xb6\xdbm\xb7", b"@\x06\xdbm\xb6\xdbm\xb7",
        b"@\x11$\x92I$\x92I", b"@\x16\xdbm\xb6\xdbm\xb7", b"@\x1c\x92I$\x92I%",
        b"@!$\x92I$\x92I", b"@$\x00\x00\x00\x00\x00\x00",
        b"@&\xdbm\xb6\xdbm\xb7", b"@)\xb6\xdbm\xb6\xdbn", ],
      "int32": [b"\x00\x00\x00\x00", b"\x00\x00\x00\x01", b"\x00\x00\x00\x02",
        b"\x00\x00\x00\x04", b"\x00\x00\x00\x05", b"\x00\x00\x00\x07",
        b"\x00\x00\x00\x08", b"\x00\x00\x00\n", b"\x00\x00\x00\x0b",
        b"\x00\x00\x00\x0c", ], "int64": [b"\x00\x00\x00\x00\x00\x00\x00\x00",
        b"\x00\x00\x00\x00\x00\x00\x00\x01",
        b"\x00\x00\x00\x00\x00\x00\x00\x02",
        b"\x00\x00\x00\x00\x00\x00\x00\x04",
        b"\x00\x00\x00\x00\x00\x00\x00\x05",
        b"\x00\x00\x00\x00\x00\x00\x00\x07",
        b"\x00\x00\x00\x00\x00\x00\x00\x08", b"\x00\x00\x00\x00\x00\x00\x00\n",
        b"\x00\x00\x00\x00\x00\x00\x00\x0b",
        b"\x00\x00\x00\x00\x00\x00\x00\x0c", ],
      "bool": [b"\x00", b"\xff", b"\xff", b"\xff", b"\xff", b"\xff", b"\xff",
        b"\xff", b"\xff", b"\xff", ], }
    ...
    for type_name in ["float", "double", "int32", "int64", "bool"]:
      ...
      for i, value in enumerate(self.data[type_name]):
        ...
        row.set_cell("fam1", type_name, value,
