...
class BigtableReadTest(unittest.TestCase):
    ...
    def test_read(self):
        ...
        self.emulator.create_table("fake_project", "fake_instance",
                "test-table", ["fam1", "fam2"])
        ...
        table.write_tensor(ten, ["fam1:col1", "fam2:col2"], ["row" +
            str(i).rjust(3, '0') for i in range(20)])
