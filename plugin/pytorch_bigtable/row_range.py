...
def prefix(prefix: str) -> pbt_C.RowRange:
  ...
  """
  return pbt_C.prefix_row_range(prefix)
...
def open(start: str, end: str) -> pbt_C.RowRange:
...
def closed(start: str, end: str) -> pbt_C.RowRange:
